...
export default function Footer() {
  const [activeModal, setActiveModal] = useState<"mentions" | "privacy" | null>(null);
    ...
    mentions: {
      ...
      content: (
        <div className="space-y-6">
          ...
          <section>
            <h3 className="text-lg font-bold">Inscription au registre du commerce et des sociétés</h3>
    ...
    privacy: {
      ...
      content: (
        <div className="space-y-6">
          ...
          <section>
            <h3 className="text-lg font-bold">Données personnelles collectées</h3>
            <p>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-6">
            <div className="flex flex-col">
              <span className="text-2xl font-serif font-bold tracking-wider">UGUR CICEK</span>
              <span className="text-[10px] uppercase tracking-[0.3em] text-accent">GROUPE IMMOBILIER</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-white/60 text-sm">
              <li><a href="#home" className="hover:text-accent transition-colors">Accueil</a></li>
              <li><a href="#about" className="hover:text-accent transition-colors">Le Groupe</a></li>
              <li><a href="#services" className="hover:text-accent transition-colors">Nos Activités</a></li>
              <li><a href="#portfolio" className="hover:text-accent transition-colors">Opportunités</a></li>
          ...
          <div>
            ...
            4 Rue Vauban 67450 Mundolsheim<br />
              Bas-Rhin,Alsace,FRANCE
            </p>
            <p className="text-white/60 text-sm">
              T: +33 9 50 56 64 89<br />
        ...
        <div className="pt-10 border-t border-white/10 flex flex-col md:flex-row justify-between items-center gap-6">
          <p className="text-white/40 text-xs">
            © {new Date().getFullYear()} Groupe Ugur Cicek. Tous droits réservés.
          </p>
          <div className="flex space-x-6 text-white/40 text-xs">
            <button onClick={() => setActiveModal("mentions")} className="hover:text-white transition-colors">Mentions Légales</button>
